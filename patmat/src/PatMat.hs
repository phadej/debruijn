...
-- match: 0 []                        |- pair (pair f x) (pair y z) -> $0 $1 $2 $3  -- INTRO: \x -> ...
-- match: 1 [x = 0]                   |- pair (pair f x) (pair y z) -> $1 $2 $3 $4  -- MATCH: case x of ...
-- alts:  1 []                        |- pair (pair f x) (pair y z) -> $1 $2 $3 $4  --   pair fx yz -> ...
-- match: 3 [fx = 1, yz = 2]          |- pair f x ; pair y z        -> $3 $4 $5 $6  -- MATCH: case fx of ...
-- alts:  3 [yz = 2]                  |- pair f x ; pair y z        -> $3 $4 $5 $6  --   pair f x -> ...
--
-- and here's it's important that we continue adding variables at the end of the context:
--
-- match: 5 [f = 3, x = 4, yz = 2 ]   |- f; z; pair y z             -> $5 $6 $7 $8
demo1 :: Expr EmptyCtx
